        ...
        <div className="studio-os-shell" style={{ minWidth: 0 }}>
          ...
          >
            ...
            <div className="studio-header-title" style={{ display: "flex", flexDirection: "column", lineHeight: 1.15 }}>
              ...
              <span className="mono" style={{ fontSize: "9.5px", color: "var(--ink3)" }}>
        ...
        <div className="studio-workspace-scroll">
          ...
          >
            <div style={{ flex: "none", display: "flex", alignItems: "baseline", gap: 9, marginBottom: 7 }}>
              ...
              <span style={{ fontSize: 10, color: "var(--ink4)" }}>one row per creative · usages aggregated</span>
              <div style={{ flex: 1 }} />
        ...
        >
          <div style={{ flex: "none", padding: "14px 16px", borderBottom: "1px solid var(--b1)", display: "flex", gap: 12, alignItems: "flex-start" }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div className="mono" style={{ fontSize: "9.5px", color: "var(--ink3)", marginTop: 3 }}>
          ...
          <div style={{ flex: "none", margin: "0 16px 8px", padding: "8px 10px", border: "1px solid var(--b1)", borderRadius: 8, background: "var(--s3)", fontSize: 10, color: "var(--ink3)", lineHeight: 1.45 }}>
