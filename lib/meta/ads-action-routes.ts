...
/**
 * Test-only handle on the private write-context resolver.
 *
 ...
 * standing up a full route. Restored during the native integration: the native
 * branch predates it and dropped the export.
 */
