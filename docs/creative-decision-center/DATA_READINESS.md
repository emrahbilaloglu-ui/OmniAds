...
| cut | mature spend, CPA/ROAS vs valid break-even, no recovery, truth | partial | V1/V2 metrics | action-specific break-even anchor, maturity, timestamp provenance | commercial truth, historical windows | diagnose_data | conditional | target age has no confidence impact; no hard cut without maturity/valid truth; peer P25 is optional only for the break-even-capped commercial stop-loss path |
