  ...
  it("does not blame queued maintenance when maintenance is not actively leased", () => {
    ...
    const reason = getGoogleAdsExtendedRecoveryBlockReason({
      ...
      queueHealth: {
        ...
        quarantinedHistoricalDeadLetterPartitions: 0,
        ...
        coreActionRequiredBlockingDeadLetterPartitions: 0,
        replayableDeadLetterPartitions: 0,
        replayableBlockingDeadLetterPartitions: 0,
        unknownDeadLetterPartitions: 0,
  ...
  it("dedupes terminal action-required scopes for lease exclusion", () => {
    expect(
      getGoogleAdsActionRequiredLeaseExcludedScopes({
        ...
        recentActionRequiredBlockingDeadLetterScopes: ["product_daily"],
        actionRequiredDeadLetterScopes: ["product_daily", "product_daily"],
        recentActionRequiredDeadLetterScopes: ["product_daily", "product_daily"],
      } as never),
    ...
    expect(
      resolveGoogleAdsWorkerRequestedLimit({
        ...
        queueHealth: {
          ...
          recentActionRequiredDeadLetterScopes: ["product_daily"],
          actionRequiredBlockingDeadLetterScopes: ["product_daily"],
          recentActionRequiredBlockingDeadLetterScopes: ["product_daily"],
          coreBlockingDeadLetterPartitions: 0,
          replayableBlockingDeadLetterPartitions: 0,
