...
export function BulkCutConfirmModal({
  ...
  return (
    <>
      ...
      >
        <div className="w-full max-w-[520px] rounded-2xl bg-white shadow-[0_8px_32px_rgba(15,23,42,0.18)] overflow-hidden">
          <div className="px-5 py-4 border-b border-slate-200 flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div id="bulk-cut-title" className="text-[15px] font-semibold text-slate-900">
                Cut {count} creatives?
              </div>
            ...
            <button
              ...
              className="text-slate-400 hover:text-slate-900 px-1 py-0.5"
              data-modal-close
              onClick={onCancel}
            >
          ...
          <div className="px-5 py-3 space-y-2 max-h-[320px] overflow-y-auto">
            {cards.map((card) => {
              ...
              return (
                <div key={card.id} className="flex items-center gap-3 rounded-lg border border-slate-200 bg-slate-50/60 px-3 py-2">
                  ...
                  <span className="font-mono tabular-nums text-[11.5px] text-slate-600">
                    {formatCurrency(card.spend)}
                  </span>
                  <span className="font-mono tabular-nums text-[11.5px] font-medium text-slate-900">
          ...
          <div className="px-5 py-3 border-t border-slate-200 bg-slate-50 flex items-center gap-4">
