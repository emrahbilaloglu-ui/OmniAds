...
export const ZERO_BASE_COPY = {
  en: {
    ...
    /* ------------------------------------------- meta decision center (v2) */
    decisionCenter: "Decision Center",
    laneActionNow: "Action Now",
    laneNeedsResolution: "Needs Resolution",
    laneWatching: "Watching",
    laneHealthy: "Healthy",
    laneNonSales: "Non-sales",
    laneArchive: "Archive",
    campaignsAndAdSets: "Campaigns & Ad sets",
    filterByLevel: "Filter decisions by level",
    allLevels: "All levels",
    levelCampaign: "Campaign",
    levelAdSet: "Ad set",
    levelAd: "Ad",
    adsAreInCreativesScope: "ads are in the Creatives scope",
    structuresAreInOtherScope: "campaigns and ad sets are in the other scope",
    levelsFromTheLink: "levels — from the link that opened this view",
    searchEntities: "Find entities",
    searchCreatives: "Find creatives",
    sortDecisions: "Sort decisions",
    sortMoneyAtStake: "Sort: Money at stake",
    ...
    engineReasoning: "Engine reasoning",
    moneyImpactVsTarget: "Money impact · ROAS vs target",
    ...
    withheldFromQueue: "Withheld from queue",
    nothingWasServed: "Nothing was served",
    ...
    queueReflectsSnapshot: "the date range scopes metrics, not decisions",
    deferred: "Deferred",
    kpiModeLabel: "Mode",
  },
  ...
  tr: {
    ...
    /* ------------------------------------------- meta decision center (v2) */
    decisionCenter: "Karar Merkezi",
    laneActionNow: "Şimdi Aksiyon",
    laneNeedsResolution: "Çözüm Bekliyor",
    laneWatching: "İzlemede",
    laneHealthy: "Sağlıklı",
    laneNonSales: "Satış dışı",
    laneArchive: "Arşiv",
    campaignsAndAdSets: "Kampanyalar ve reklam setleri",
    filterByLevel: "Kararları seviyeye göre süz",
    allLevels: "Tüm seviyeler",
    levelCampaign: "Kampanya",
    ...
    sortDecisions: "Kararları sırala",
    sortMoneyAtStake: "Sırala: Risk altındaki tutar",
    ...
    serverVerdict: "Sunucu kararı",
    engineReasoning: "Motorun gerekçesi",
    moneyImpactVsTarget: "Parasal etki · hedefe karşı ROAS",
    confidence: "Güven",
    readiness: "Hazırlık",
    blockers: "Engeller",
    ...
    capabilityGaps: "Yetenek boşlukları",
    withheldFromQueue: "Kuyruktan alıkonuldu",
    nothingWasServed: "Hiçbir şey sunulmadı",
    reviewEvidence: "Kanıtı incele",
    review: "İncele",
    resume: "Sürdür",
    note: "Not",
    inspecting: "İnceleniyor",
    ctrWindowed: "CTR · 28g",
    decisionWindowed: "Karar · 28g",
    ...
    queueReflectsSnapshot: "tarih aralığı metrikleri kapsar, kararları değil",
    deferred: "Ertelenen",
    kpiModeLabel: "Mod",
  },
} as const;
