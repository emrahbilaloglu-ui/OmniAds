...
| --- | --- | --- |
| `ENGINE_VERSION` | `v3-2026-09-24-zero-conversion-cut-floor` (D107) | `lib/creative-decision-engine/types.ts` |
| `NATIVE_AD_ENGINE_VERSION` | `v3-ad-2026-09-24-config-gap-window-shadow` (D107) | `lib/creative-decision-engine/types.ts` |
...
| `AD_DECISION_EVALUATION_CONTRACT_VERSION` | `engine-v3-canonical-ad-evaluation.v16` (D107) | `lib/creative-decision-engine/evaluation-store.ts` |
