...
> = {
  ...
  keep: {
    ...
    metaClassName: "bg-neutral-50 text-neutral-700 border-neutral-200",
    legacyClassName: TONE_CLASS.info,
  },
  test_more: {
    label: "Test more",
    tone: "muted",
    creativeClassName: "text-neutral-700 bg-neutral-100 border-neutral-200",
    metaClassName: "bg-neutral-50 text-neutral-700 border-neutral-200",
  ...
  out_of_scope: {
    label: "Out of scope",
    tone: "muted",
    creativeClassName: "text-neutral-500 bg-transparent border-neutral-200",
    metaClassName: "bg-neutral-50 text-neutral-700 border-neutral-200",
    legacyClassName: TONE_CLASS.muted,
  },
};
