...
const ENGINE_COLORS: Record<string, string> = {
  ChatGPT: "bg-[var(--adc-pos-bg)] text-[var(--adc-pos-fg)]  ",
  Perplexity: "bg-[var(--adc-auto-bg)] text-[var(--adc-auto-fg)]  ",
  Gemini: "bg-[var(--adc-info-bg)] text-[var(--adc-info-fg)]  ",
  Copilot: "bg-[var(--adc-info-bg)] text-[var(--adc-info-fg)]  ",
  Claude: "bg-[var(--adc-caution-bg)] text-[var(--adc-caution-fg)]  ",
  "You.com": "bg-pink-100 text-pink-800 dark:bg-pink-900/40 dark:text-pink-300",
  Phind: "bg-[var(--adv-fill-2)] text-[var(--adv-ink)]  ",
