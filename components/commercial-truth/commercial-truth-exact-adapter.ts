  ...
  const fields: CommercialTruthFieldModel[] = [
    {
      ...
      hint: "Primary Scale anchor. CPA can be derived from this and observed AOV.",
      accent: true,
    ...
    },
    {
      ...
      hint: "Optional override. Shopify observed AOV is used when available; otherwise AOV ÷ Target ROAS sets the spend unit.",
      accent: false,
      editable: input.pack.canEdit,
    },
    {
    ...
    },
    {
      ...
      hint: "Optional spend unit override. If blank, it is derived from Target ROAS and observed AOV. This unlocks the threshold only; freshness, role and governance still apply.",
      accent: false,
      editable: input.pack.canEdit,
    },
    {
